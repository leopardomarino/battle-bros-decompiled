this.defend_settlement_greenskins_action <- this.inherit("scripts/factions/faction_action", {
	m = {},
	function create()
	{
	...
	{
		local contract = this.new("scripts/contracts/contracts/defend_settlement_greenskins_contract");
