this.hunting_sand_golems_action <- this.inherit("scripts/factions/faction_action", {
	m = {},
	function create()
	{
	...
	{
		local contract = this.new("scripts/contracts/contracts/hunting_sand_golems_contract");
