this.conquer_holy_site_action <- this.inherit("scripts/factions/faction_action", {
	m = {},
	function create()
	{
	...
	function onExecute( _faction )
	{
		...
		{
			contract = this.new("scripts/contracts/contracts/conquer_holy_site_southern_contract");
		}
		else
		{
			contract = this.new("scripts/contracts/contracts/conquer_holy_site_contract");
		}
