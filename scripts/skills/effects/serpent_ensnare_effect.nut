this.serpent_ensnare_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Description = "This character is entangled in a giant serpent. Each turn, the serpent threatens to crush them by gripping ever tighter, resulting in the loss of [color=" + this.Const.UI.Color.NegativeValue + "]10[/color] hitpoints.";
