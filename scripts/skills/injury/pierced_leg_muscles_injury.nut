this.pierced_leg_muscles_injury <- this.inherit("scripts/skills/injury/injury", {
	...
	function create()
	{
		...
		this.m.Name = "Pierced Leg Muscles";
		this.m.Description = "Punctured leg muscles make any attempts to do quick and sudden movements a painful experience, if not outright impossible.";
