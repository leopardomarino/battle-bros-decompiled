this.fractured_skull_injury <- this.inherit("scripts/skills/injury/injury", {
	...
	function create()
	{
		...
		this.m.Name = "Fractured Skull";
		this.m.Description = "This character\'s skull has sustained multiple fractures, and the brain has sustained blunt trauma leading to swelling and a build-up of pressure inside the skull.";
