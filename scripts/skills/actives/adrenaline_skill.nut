this.adrenaline_skill <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Description = "Feel the adrenaline rushing through your veins as you seize the opportunity to act faster than your opponent.";
	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "Puts this character first in next round\'s turn order"
			}
		];
		return ret;
	}
