this.steppe1 <- this.inherit("scripts/mapgen/tactical_template", {
	m = {
		Details = [
			"steppe_flowers_01",
			"steppe_flowers_02",
	...
	function init()
	{
		...
		t.setBrush(this.Const.Direction.N, "transition_steppe_01_N");
		t.setBrush(this.Const.Direction.NE, "transition_steppe_01_NE");
		t.setBrush(this.Const.Direction.SE, "transition_steppe_01_SE");
		t.setBrush(this.Const.Direction.S, "transition_steppe_01_S");
		t.setBrush(this.Const.Direction.SW, "transition_steppe_01_SW");
		t.setBrush(this.Const.Direction.NW, "transition_steppe_01_NW");
		t.setSocket("socket_steppe");
		this.Tactical.setTransitions("tile_steppe_01", t);
	}
	...
	function onFirstPass( _rect )
	{
		...
		tile.BlendPriority = this.Const.Tactical.TileBlendPriority.Steppe1;
