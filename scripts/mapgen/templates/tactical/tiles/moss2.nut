this.moss2 <- this.inherit("scripts/mapgen/tactical_template", {
	m = {
		DetailsA = [
			"detail_forest_01",
			"detail_forest_02",
	...
	function init()
	{
		...
		t.setBrush(this.Const.Direction.N, "transition_moss_02_N");
		t.setBrush(this.Const.Direction.NE, "transition_moss_02_NE");
		t.setBrush(this.Const.Direction.SE, "transition_moss_02_SE");
		t.setBrush(this.Const.Direction.S, "transition_moss_02_S");
		t.setBrush(this.Const.Direction.SW, "transition_moss_02_SW");
		t.setBrush(this.Const.Direction.NW, "transition_moss_02_NW");
		t.setSocket("socket_earth");
		this.Tactical.setTransitions("tile_moss_02", t);
	}
