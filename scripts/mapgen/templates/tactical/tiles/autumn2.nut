this.autumn2 <- this.inherit("scripts/mapgen/tactical_template", {
	m = {
		Details = [
			"tundra_grass_01",
			"tundra_grass_02",
	...
	function init()
	{
		...
		t.setBrush(this.Const.Direction.N, "transition_autumn_02_N");
		t.setBrush(this.Const.Direction.NE, "transition_autumn_02_NE");
		t.setBrush(this.Const.Direction.SE, "transition_autumn_02_SE");
		t.setBrush(this.Const.Direction.S, "transition_autumn_02_S");
		t.setBrush(this.Const.Direction.SW, "transition_autumn_02_SW");
		t.setBrush(this.Const.Direction.NW, "transition_autumn_02_NW");
		t.setSocket("socket_earth");
		this.Tactical.setTransitions("tile_autumn_02", t);
	}
	...
	function onFirstPass( _rect )
	{
		...
		tile.BlendPriority = this.Const.Tactical.TileBlendPriority.Autumn2;
		tile.IsBadTerrain = false;
		tile.setBrush("tile_autumn_02");
		local n = 0;
