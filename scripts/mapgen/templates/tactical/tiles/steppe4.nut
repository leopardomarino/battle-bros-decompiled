this.steppe4 <- this.inherit("scripts/mapgen/tactical_template", {
	m = {
		Details = [
	...
	function init()
	{
		...
		t.setBrush(this.Const.Direction.N, "transition_steppe_04_N");
		t.setBrush(this.Const.Direction.NE, "transition_steppe_04_NE");
		t.setBrush(this.Const.Direction.SE, "transition_steppe_04_SE");
		t.setBrush(this.Const.Direction.S, "transition_steppe_04_S");
		t.setBrush(this.Const.Direction.SW, "transition_steppe_04_SW");
		t.setBrush(this.Const.Direction.NW, "transition_steppe_04_NW");
		t.setSocket("socket_steppe");
		this.Tactical.setTransitions("tile_steppe_04", t);
	}
	...
	function onFirstPass( _rect )
	{
		...
		tile.BlendPriority = this.Const.Tactical.TileBlendPriority.Steppe4;
		tile.IsBadTerrain = false;
		tile.setBrush("tile_steppe_04");
		local n = 0;
