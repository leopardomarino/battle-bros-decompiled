this.swamp2 <- this.inherit("scripts/mapgen/tactical_template", {
	m = {
		Details = [
			"swamp_grass_03",
			"swamp_grass_04",
	...
	function init()
	{
		...
		t.setBrush(this.Const.Direction.N, "transition_swamp_02_N");
		t.setBrush(this.Const.Direction.NE, "transition_swamp_02_NE");
		t.setBrush(this.Const.Direction.SE, "transition_swamp_02_SE");
		t.setBrush(this.Const.Direction.S, "transition_swamp_02_S");
		t.setBrush(this.Const.Direction.SW, "transition_swamp_02_SW");
		t.setBrush(this.Const.Direction.NW, "transition_swamp_02_NW");
		t.setSocket("socket_earth");
		this.Tactical.setTransitions("tile_swamp_02", t);
	}
	...
	function onFirstPass( _rect )
	{
		...
		tile.BlendPriority = this.Const.Tactical.TileBlendPriority.Swamp2;
