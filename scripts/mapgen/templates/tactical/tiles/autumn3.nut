this.autumn3 <- this.inherit("scripts/mapgen/tactical_template", {
	m = {
		Details = [
			"tundra_flowers_01",
			"tundra_flowers_02",
	...
	function init()
	{
		...
		t.setBrush(this.Const.Direction.N, "transition_autumn_03_N");
		t.setBrush(this.Const.Direction.NE, "transition_autumn_03_NE");
		t.setBrush(this.Const.Direction.SE, "transition_autumn_03_SE");
		t.setBrush(this.Const.Direction.S, "transition_autumn_03_S");
		t.setBrush(this.Const.Direction.SW, "transition_autumn_03_SW");
		t.setBrush(this.Const.Direction.NW, "transition_autumn_03_NW");
		t.setSocket("socket_earth");
		this.Tactical.setTransitions("tile_autumn_03", t);
	}
	...
	function onFirstPass( _rect )
	{
		...
		tile.BlendPriority = this.Const.Tactical.TileBlendPriority.Autumn3;
		tile.IsBadTerrain = false;
		tile.setBrush("tile_autumn_03");
		local n = 0;
