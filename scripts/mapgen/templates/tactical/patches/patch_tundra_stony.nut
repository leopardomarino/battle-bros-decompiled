this.patch_tundra_stony <- this.inherit("scripts/mapgen/tactical_template", {
	m = {},
	function init()
	{
	...
	{
		local tundra1Tile = this.MapGen.get("tactical.tile.tundra3");
		local tundra2Tile = this.MapGen.get("tactical.tile.tundra2");
