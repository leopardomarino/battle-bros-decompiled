this.patch_hill_snow <- this.inherit("scripts/mapgen/tactical_template", {
	m = {},
	function init()
	{
	...
	function fill( _rect, _properties, _pass = 1 )
	{
		...
		local tile2 = this.MapGen.get("tactical.tile.snow1");
		local tile3 = this.MapGen.get("tactical.tile.snow2");
		local tile4 = this.MapGen.get("tactical.tile.snow3");
